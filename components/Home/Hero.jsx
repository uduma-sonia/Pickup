    ...
    <div className="mx-auto max-w-[1300px] py-14 xl:py-28 px-6 xl:px-16">
      <div className="flex flex-col xl:flex-row justify-between items-center">
        <div className="w-full xl:w-1/2 max-w-[400px] text-center xl:text-left">
          ...
          <p className="text-sm text-primary font-normal my-6 hero_text_description opacity-0">
            The quickest and least expensive way to travel. Get a ride and
            arrive at your location on time.
          </p>

          <div className="flex gap-5 hero_buttons opacity-0">
        ...
        <div className="w-full xl:w-1/2 mt-12 xl:mt-0 flex items-center justify-center">
          <div className="h-72 relative w-72">
            <div className="hero_main_image shadow-lg opacity-0">
              <Image
            ...
            <div className="w-[100px] hero_left_image opacity-0 h-[100px] absolute bottom-5 shadow-xl rounded-xl -left-6 xl:-left-16">
              <Image
                className="rounded-xl"
            ...
            <div className="w-[100px] hero_right_image opacity-0 h-[100px] absolute top-5 -right-6 xl:-right-16 shadow-xl rounded-xl">
              <Image
                className="rounded-xl"
